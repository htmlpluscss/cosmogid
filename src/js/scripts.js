	...
	form.addEventListener('change', event => {
		...
		if(event.target.getAttribute('type') === 'file') {
			...
			const label = event.target.parentNode,
				  small = label.querySelector('.input-file__label small');
